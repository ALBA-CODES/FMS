...
int main(int argc, char* argv[])
{
	...
	// PT initiation. temp values. size of the MCMC and the Number of exchange proposals between temp
	PT *algo;
	algo = new PT(tempIni,tempfim,tempN,MCL,PTL,tempUp, tempD);
	algo->loadInstance(fn);
	algo->start(mType, mForce, uType);
