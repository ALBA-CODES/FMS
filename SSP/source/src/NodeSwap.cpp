...
NodeSwap::NodeSwap(Node* left_, Node* right_, Consumer *pool_, int PTL_)
:left(left_)
,right(right_)
,pool(pool_)
{
...
NodeSwap::NodeSwap(Node* left_, Node* right_,Node* tempUp_ , Consumer* pool_, int PTL_, int UPL_)
:left(left_)
,right(right_)
,tempUp(tempUp_)
,pool(pool_)
